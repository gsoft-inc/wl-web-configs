...
To view the default development configuration of this library, have a look at the [configuration file](https://github.com/gsoft-inc/wl-web-configs/blob/main/packages/tsup-configs/src/dev.ts) on Github.
