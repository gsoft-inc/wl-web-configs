...
!!!info
If your project is using `@workleap/wepack-config`, you don't have to configure the `postcss-loader` as the [defineDevConfig](../webpack/configure-dev.md#definedevconfig) and [defineBuildConfig](../webpack/configure-build.md#definebuildconfig) functions already takes care of configuring PostCSS.
!!!
